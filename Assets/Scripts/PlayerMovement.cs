...
public class PlayerMovement : MonoBehaviour, FSMTest.IStateRunner
{
    ...
    public FSMTest.StateMachine playerStateMachine;
    ScratchPad IStateRunner.sharedData { get; }
    ...
    void Start()
    {
        ...
        playerStateMachine.SetState(new PlayerIdleState());
    }
